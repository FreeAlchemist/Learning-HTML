...
for (var i = 0; i < quantity; i++) {
	...
	$('#'+cardfrontid).append($('<div />',{class:'front',id:cardfrontid+'-bg'}))
	$('#'+cardfrontid+'-bg').append($('<div />',{class:'title pursuit-title',text:pursuit[cardid].name}))
	$('#'+cardfrontid+'-bg').append($('<div />',{class:'text pursuit-text',text:pursuit[cardid].text}))

	var gearid = cardfrontid+'-bg'+'-gear'
	$('#'+cardfrontid+'-bg').append($('<table />',{class:'text step',id:gearid,cellspacing:'0',cellpadding:'2'}))
	...
	$('#'+cardfrontid+'-bg').append($('<div />',{class:'title',text:pursuit[cardid].talent['name']}))
	$('#'+cardfrontid+'-bg').append($('<div />',{class:'text talent-text',text:pursuit[cardid].talent['text']}))

	var stepid = cardfrontid+'-bg'+'-step'
	$('#'+cardfrontid+'-bg').append($('<table />',{class:'text step',id:stepid,cellspacing:'0',cellpadding:'0'}))
